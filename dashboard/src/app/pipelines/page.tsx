...
import { getPipelines, getStages, getDeals, seedPipeline, createPipeline, updateDealStage } from "@/app/actions/pipelines";
...
export default function PipelinesPage() {
  ...
  const loadStages = useCallback(
    async (pipelineId: string) => {
      try {
        return await getStages(pipelineId);
      } catch (e) {
        return [];
      }
    },
  ...
  const loadDeals = useCallback(
    async (pipelineId: string) => {
      try {
        return await getDeals(pipelineId);
      } catch (e) {
        return [];
      }
    },
