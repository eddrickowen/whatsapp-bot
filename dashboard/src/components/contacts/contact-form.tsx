...
import { getTags, createContact, updateContact } from '@/app/actions/contacts';
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (isEdit && contact?.id) {
        await updateContact(contact.id, payload, selectedTagIds);
      } else {
        await createContact(payload, selectedTagIds);
      }
